...
public final class TimeUtils {
    ...
    public static String getFriendlyTimeSpanByNow(final long millis) {
        ...
        if (span < 1000) {
            ...
            return String.format(Locale.getDefault(), "%dseconds before", span / TimeConstants.SEC);
        } else if (span < TimeConstants.HOUR) {
            return String.format(Locale.getDefault(), "%dminutes before", span / TimeConstants.MIN);
        }
        // 获取当天 00:00
        long wee = getWeeOfToday();
        if (millis >= wee) {
            return String.format("today%tR", millis);
    ...
    private static String millis2FitTimeSpan(long millis, int precision) {
        ...
        String[] units = {"day", "hours", "minutes", "seconds", "ms"};
