...
public class CallTimerView extends View {

    private static final String TAG = "CallTimerView";
    ...
    public CallTimerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
    ...
    private void init(@Nullable AttributeSet attrs) {
        ...
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.CallTimerView);
        textSize = ta.getDimensionPixelSize(R.styleable.CallTimerView_android_textSize, (int) dpToPx(12, getResources()));
        color = ta.getColor(R.styleable.CallTimerView_android_textColor, Color.WHITE);
        textAppearanceRef = ta.getResourceId(R.styleable.CallTimerView_android_textAppearance, 0);
        ta.recycle();
    ...
    public void start() {
        ...
        timerRunning = true;
        timer = new CallTimer(Integer.MAX_VALUE, 100) {
            @Override
