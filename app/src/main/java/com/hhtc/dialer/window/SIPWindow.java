...
public class SIPWindow implements View.OnTouchListener, View.OnClickListener {
    ...
    public SIPWindow(Context context) {
    ...
    public void showFloatWindow(String name) {
        if (state == HIND) {
            ...
            TextView hostName = mFloatLayout.findViewById(R.id.remoteName);
